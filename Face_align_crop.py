...
'''
img = cv2.imread('D:\Daxue_Document\Face_Recognition\MTCNN\Face_crop_align_mtcnn-master\input\vggface2\n000001\0001_01')
cv2.imshow('D:\Daxue_Document\Face_Recognition\MTCNN\Face_crop_align_mtcnn-master\input\vggface2\n000001\0001_01',img)
'''
print ('D:\Daxue_Document\Face_Recognition\MTCNN\Face_crop_align_mtcnn-master\datasets\\vggface2\\n000001\0001_01.imdb' )
def getArgs():
    parser = argparse.ArgumentParser()
    parser.add_argument('--input_path', type=str, default='D:\Daxue_Document\Face_Recognition\MTCNN\Face_crop_align_mtcnn-master\datasets\\vggface2\\n000009', help='the dir your dataset of face which need to crop')
    parser.add_argument('--output_path', type=str, default='D:\Daxue_Document\Face_Recognition\MTCNN\Face_crop_align_mtcnn-master\output\\vggface2\\n000009', help='the dir the cropped faces of your dataset where to save')
    ...
    parser.add_argument('--face_size', type=str, default='112', help='the size of the face to save, the size x%2==0, and width equal height')
